...
public class VerdanceBlockEntityTypes {
    public static final BlockEntityType<SilkCocoonBlockEntity> SILK_COCOON = register("silk_cocoon", BlockEntityType.Builder.create(SilkCocoonBlockEntity::new, VerdanceBlocks.SILK_COCOON));
