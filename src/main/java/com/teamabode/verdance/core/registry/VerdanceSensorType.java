...
import com.teamabode.verdance.common.entity.silk_moth.sensor.NightSensor;
...
public class VerdanceSensorType {
    ...
    public static final SensorType<NightSensor> NIGHT = register("night", NightSensor::new);
