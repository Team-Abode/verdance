...
public class SilkMothEntityModel extends SinglePartEntityModel<SilkMothEntity> {
	...
	public static TexturedModelData createBodyLayer() {
		...
		head.addChild("right_antenna", ModelPartBuilder.create().uv(20, -7).cuboid(0.0F, -7.0F, -7.0F, 0.0F, 7.0F, 7.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.0F, -3.0F, -2.0F));
		head.addChild("left_antenna", ModelPartBuilder.create().uv(20, -7).cuboid(0.0F, -7.0F, -7.0F, 0.0F, 7.0F, 7.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, -3.0F, -2.0F));
		body.addChild("left_leg_front", ModelPartBuilder.create().uv(48, 0).cuboid(0.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(4.0F, 4.0F, -3.0F));
		body.addChild("left_leg_mid", ModelPartBuilder.create().uv(48, 0).cuboid(0.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(4.0F, 4.0F, 1.0F));
		body.addChild("left_leg_back", ModelPartBuilder.create().uv(48, 0).cuboid(0.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(3.0F, 4.0F, 5.0F));
		body.addChild("right_leg_front", ModelPartBuilder.create().uv(48, 0).mirrored().cuboid(-6.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-5.0F, 4.0F, -3.0F));
		body.addChild("right_leg_mid", ModelPartBuilder.create().uv(48, 0).mirrored().cuboid(-6.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-5.0F, 4.0F, 1.0F));
		body.addChild("right_leg_back", ModelPartBuilder.create().uv(48, 0).mirrored().cuboid(-6.0F, -1.0F, -1.0F, 6.0F, 2.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-4.0F, 4.0F, 5.0F));
		body.addChild("left_wing", ModelPartBuilder.create().uv(14, 7).mirrored().cuboid(0.0F, 0.0F, -9.5F, 12.0F, 0.0F, 18.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(4.0F, -2.0F, -1.0F));
		body.addChild("right_wing", ModelPartBuilder.create().uv(14, 7).cuboid(-12.0F, 0.0F, -9.5F, 12.0F, 0.0F, 18.0F, new Dilation(0.0F)), ModelTransform.pivot(-5.0F, -2.0F, -1.0F));
	...
	public void setAngles(SilkMothEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
		...
		this.updateAnimation(entity.idleAnimationState, VerdanceAnimations.SILK_MOTH_IDLE, animationProgress);

		if (entity.isOnGround() && !entity.isInAir()) {
			this.animateMovement(VerdanceAnimations.SILK_MOTH_WALK, limbAngle, limbDistance, 2.0f, 2.5f);
		}
		this.updateAnimation(entity.flyAnimationState, VerdanceAnimations.SILK_MOTH_FLY,  animationProgress);
