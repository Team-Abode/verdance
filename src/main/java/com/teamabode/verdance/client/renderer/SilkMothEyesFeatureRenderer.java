...
public class SilkMothEyesFeatureRenderer extends EyesLayer<SilkMoth, SilkMothModel> {
    private static final RenderType EYES = RenderType.eyes(Verdance.id("textures/entity/silk_moth/eyes.png"));

    public SilkMothEyesFeatureRenderer(RenderLayerParent<SilkMoth, SilkMothModel> renderLayerParent) {
