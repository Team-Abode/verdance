...
public class SilkMothEyesFeatureRenderer extends EyesFeatureRenderer<SilkMothEntityRenderState, SilkMothEntityModel> {
    private static final RenderLayer EYES = RenderLayer.getEyes(Verdance.id("textures/entity/silk_moth/eyes.png"));

    public SilkMothEyesFeatureRenderer(FeatureRendererContext<SilkMothEntityRenderState, SilkMothEntityModel> renderLayerParent) {
