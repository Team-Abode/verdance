...
public class SilkMothEyesLayer extends EyesFeatureRenderer<SilkMothEntity, SilkMothModel> {
    private static final RenderLayer EYES = RenderLayer.getEyes(Verdance.id("textures/entity/silk_moth/eyes.png"));

    public SilkMothEyesLayer(FeatureRendererContext<SilkMothEntity, SilkMothModel> renderLayerParent) {
